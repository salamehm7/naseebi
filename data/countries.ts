// Modified country list with countries and their ISO codes (for flags)
...
// Helper function to get country names only
export const getCountryNames = (): string[] => {
  return countries.map(country => country.name);
};

// Helper function to get country by name
export const getCountryByName = (name: string): { name: string; code: string } | undefined => {
